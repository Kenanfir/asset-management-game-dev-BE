...
export class FileValidationService {
    ...
    private async validateImageFile(file: Express.Multer.File, mimeType: string): Promise<void> {
    ...
    private async validateAudioFile(file: Express.Multer.File, mimeType: string): Promise<void> {
